...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
for varID = 1:numPeople
    parents = pedigree.parents(varID,:);
    if all(parents) % all non-zero
        factorList(varID) = genotypeGivenParentsGenotypesFactor(numAlleles,varID,parents(1),parents(2));
    else
        factorList(varID) = genotypeGivenAlleleFreqsFactor(alleleFreqs,varID);
    end
    factorList(varID+numPeople) = phenotypeGivenGenotypeFactor(alphaList,varID,varID+numPeople);
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  