...
for i = 1:genotypeFactor.card
    genotype = genotypesToAlleles(i,:);
    if (genotype(1) == genotype(2))
        genotypeFactor.val(i) = alleleFreqs(genotype(1))*alleleFreqs(genotype(2));
    else
        genotypeFactor.val(i) = 2*alleleFreqs(genotype(1))*alleleFreqs(genotype(2));
    end
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  