...
num_genotype = length(alphaList);
phenotypeFactor.var = [phenotypeVar, genotypeVar];
phenotypeFactor.card = [2, num_genotype];
...
% phenoVar by genoVar matrix
A = [ones(1,num_genotype), 2*ones(1,num_genotype);
     1:num_genotype, 1:num_genotype]';
% alphaList for phenoVar=1 followed by phenoVar=2
v = [alphaList;
    1-alphaList];
