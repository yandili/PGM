...
% ith row(assignment) = every combination of the assignment of C
% ith row(indxA) = the index of A table corresponding to the ith assign.of C
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% ith row of C corresp.to the ith row indxA and indxB
