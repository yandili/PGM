  ...
  for i = 1:size([u, v], 1)
      ...
      if u(i) > v(i)
          ...
          elseif strcmp(TransName, 'MHSwendsenWang2')
              ...
              %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
              % q is proportional to the probability that u(i)==v(i)
              d = min(edge_factor.card);
              denom = sum(GetValueOfAssignment(edge_factor, repmat(1:d,2,1)'));
              nom = sum(edge_factor.val);
              q_ij = denom/nom;
              %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
