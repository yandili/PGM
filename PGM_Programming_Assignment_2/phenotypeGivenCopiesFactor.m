...
for i = 1:size(assignment,1)
    ...
    allele1 = assignment(i,2);
    allele2 = assignment(i,3);
    if phenotype == 1
        phenotypeFactor.val(i) = alphaList(allelesToGenotypes(allele1,allele2));
    else
        phenotypeFactor.val(i) = 1 - alphaList(allelesToGenotypes(allele1,allele2));
    end
end
